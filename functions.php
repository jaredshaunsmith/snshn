...
class WeDevs_Bootstrap {
    ...
    function enqueue_scripts() {
        ...
        wp_enqueue_script( 'theme-sc', 'http://connect.soundcloud.com/sdk.js', array('jquery'), '20120206', true );
        wp_enqueue_script( 'theme-scW', 'https://w.soundcloud.com/player/api.js', array('jquery'), '20120206', true );
